...
import { ArrowDown, Clock, Loader, Star } from "lucide-react";
  ...
  return <div className="flex gap-5">
    ...
    <div className="flex flex-col justify-between">
      ...
      <div className="flex items-center gap-2">
        ...
        <button className="text-red-500 font-semibold rounded hover:bg-red-100 transition py-1 px-3">Yorumlari Gör</button>
      </div>
    </div>
  </div>;
};
